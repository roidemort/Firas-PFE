...
@Component({
  selector: '[app-table-partner-row]',
  standalone: true,
...
export class TableRowComponent {
  ...
  onEditPartner(partnerId: string){
    this.updatePartner.emit(partnerId);
  }
}
